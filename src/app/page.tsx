...
export default function DashboardPage() {
  ...
  const stats = useMemo(() => {
    ...
    return {
      ...
      tresUrgent: demandes.filter((d) => d.urgence === 'TRES_URGENT').length,
      urgent: demandes.filter((d) => d.urgence === 'URGENT').length,
      normal: demandes.filter((d) => d.urgence === 'NORMAL').length,
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        ...
        <div className="bg-red-50 rounded-xl border border-red-200 shadow-sm p-5">
          <div className="flex items-center justify-between">
            ...
            <span className="text-2xl font-extrabold text-red-700 tabular-nums">
          ...
          <div className="flex items-end gap-4 mt-3">
            ...
            <div className="text-center">
              <p className="text-2xl font-extrabold text-orange-500 tabular-nums">
                {stats.urgent}
              </p>
