    ...
    <AppShell showSearch={false}>
      ...
      {chargement ? (
        ...
        <div className="space-y-3">
          {filtrees.map((d) => {
            ...
            return (
              <div key={d.id} className={'bg-blue-50/90 rounded-xl border border-blue-500/60 shadow-sm border-l-4 p-4 ' + s.bord}>
      ...
      {demandeActive && sActive && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm px-4">
          <div className="bg-surface rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden border border-blue-500/60">
